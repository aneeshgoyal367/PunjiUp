...
function Mid(){
    return(
        ...
        <p>A close-ended fund is a kind of mutual fund that pools resources from numerous investors through issuance of New Fund Offer (NFO). An investor buys units of the fund during the NFO period. The units are sold at a price based on Net Asset Value of the mutual fund that is launching the NFO.
            ...
            Sometimes close-ended funds trade at a discounted price on their Net Asset Value (NAV). New investors can capitalize on this difference to earn decent returns in the future, as redemptions on maturity happens at NAV.</p>
        <img src="assets\photos\closed.png" alt="closepic" className="center" height="350" />
